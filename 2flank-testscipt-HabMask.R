...
source("sim2flank.HabMask.R")
source("init.2flank.HabMask.R")
source("LRmatch.R")
library(nimble)
source("NimbleModel 2Flank HabMask.R")
source("NimbleFunctions 2Flank HabMask.R")
...
data <- sim2flank.HabMask(N=N,p0L=p0L,p0R=p0R,p0B=p0B,sigma=sigma,K=K,X=X,buff=buff,K2D=K2D,n.fixed=n.fixed,
...
constants <- list(M=M,J=J,K=K,K2D=K2D,xlim=nimbuild$xlim,ylim=nimbuild$ylim,n.L=n.L,n.R=n.R,res=res)
